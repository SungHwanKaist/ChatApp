...
public interface Service {
    ...
    String CHAT_IMAGE_URL = "http://52.231.66.86:3000/uploads/"; // uploaded images folder path
    String BASE_URL = "http://52.231.66.86:3000/";  // change to your ip/server address
